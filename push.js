...
process.env.LIGHTDB_USER = "aoshixukai";
process.env.LIGHTDB_PASS = "a052810";
process.env.LIGHTDB_HOST ="db.alphabets.cn";
process.env.LIGHTDB_PORT = "57017";
process.env.APPNAME      = "8de206b713ab";
  ...
  loadFromFile(handler, dir, source, function (err) {    
    ...
    rider.setting.list(handler, function (err, result) {
       ...
       if(to)
        ...
        //新建数据
        rider.setting.add(handler,{data:{"key" : "LastCommit",
                                         "value" : commit,
                                         "description" : "最终更新",}},callback);        
    });  
  });
}
